...
# $Date: 2020-06-21 06:49:20 -0700 (Sun, 21 Jun 2020) $
# $Author: toby $
# $Revision: 4505 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIconstrGUI.py $
# $Id: GSASIIconstrGUI.py 4505 2020-06-21 13:49:20Z toby $
########### SVN repository information ###################
'''
*GSASIIconstrGUI: Constraint GUI routines*
------------------------------------------
...
import GSASIIpath
GSASIIpath.SetVersionNumber("$Revision: 4505 $")
...
def UpdateRigidBodies(G2frame,data):
    ...
    def ExtractPhaseRB(event):
        ...
        def Page2():
            ...
            def onAddVector(event):
                ...
                '''
                grid.completeEdits()
                rb = MakeVectorBody(os.path.split(filename)[1])
    ...
    def ImportResidueRB():
        ...
        if len(atNames) < 3:
            ...
            data['Residue'][resRBsel] = {'RBname':'UNKRB','rbXYZ':rbXYZ,'rbTypes':rbTypes,
