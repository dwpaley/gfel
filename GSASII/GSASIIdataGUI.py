...
# $Date: 2020-07-18 15:00:20 -0700 (Sat, 18 Jul 2020) $
# $Author: toby $
# $Revision: 4525 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIdataGUI.py $
# $Id: GSASIIdataGUI.py 4525 2020-07-18 22:00:20Z toby $
########### SVN repository information ###################
'''
...
try:
    ...
    pass
import GSASIIpath
GSASIIpath.SetVersionNumber("$Revision: 4525 $")
...
#            help='Reorganize variables where variables change')
        ...
        G2G.Define_wxId('wxID_PEAKSMOVE', 'wxID_PEAKSCLEAR','wxID_PEAKSUNIQUE', 'wxID_PEAKSDELETE','wxID_PEAKSSAVE','wxID_PEAKSDA',
            'wxID_PEAKSDISTVP', 'wxID_PEAKSVIEWPT', 'wxID_FINDEQVPEAKS', 'wxID_SHOWBONDS','wxID_INVERTPEAKS',)
