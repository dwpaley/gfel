...
# $Date: 2020-07-19 09:21:51 -0700 (Sun, 19 Jul 2020) $
# $Author: toby $
# $Revision: 4527 $
# $URL: https://subversion.xray.aps.anl.gov/pyGSAS/trunk/GSASIIpwd.py $
# $Id: GSASIIpwd.py 4527 2020-07-19 16:21:51Z toby $
########### SVN repository information ###################
...
import GSASIIpath
filversion = "$Revision: 4527 $"
GSASIIpath.SetVersionNumber("$Revision: 4527 $")
